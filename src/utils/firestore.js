...
export async function createQuestionnaire({ title, description, isPublished }) {
...
export async function submitResult({ name, department, quizId, quizTitle, answers, score, total }) {
